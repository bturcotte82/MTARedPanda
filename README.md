...
It can be heavy for smaller or mid-size teams. If you want quick local dev cycles or a simpler operational overhead, Kafka's multi-node architecture, plus ZooKeeper, can feel like you're setting up a second job.
...
Have fun tracking those trains!
